		...
		<div id="content" class="site-content" role="main">
			...
			<?php while ( have_posts() ) : the_post(); ?>
				...
				<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
						...
						<?php else : ?>
							<?php // By default an advent calender entry does not have "content", just a title and a
								  // featured image, consider to customize the advent calender post type via provided
								  // hook if you need "content".
							?>
						<?php endif; ?>
